...
cd /home/wy/RS/A3/ros2_ws
source install/setup.bash
ros2 run moveit_servo servo_node --ros-args --params-file src/rs_a3_teleop/config/moveit_servo_config.yaml
```
...
```bash
cat /home/wy/RS/A3/ros2_ws/src/rs_a3_teleop/README.md
```
