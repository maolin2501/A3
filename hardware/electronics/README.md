...
本目录存放 RS-A3 机械臂相关的电路板设计文件和电气资料。

This directory contains PCB design files and electrical documentation for the RS-A3 robotic arm.
...
- `rs_a3_hardware/` — ROS2 CAN 驱动代码

## 文件命名规范 / File Naming Convention

```
RS-A3_<板卡名>_<版本>.<扩展名>
例：RS-A3_driver_board_v1.kicad_pcb
    RS-A3_power_board_schematic_v2.pdf
```
